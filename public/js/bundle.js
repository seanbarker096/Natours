...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VhbmJhcmtlciIsImEiOiJja2p0MmUyZTkxM2tsMnFxaGN0dGk1MGo5In0.-kzqHxyy0WSaKL0UvAzzoA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              //set true so gets new page from server, rather than using page in cache
              //Page reloads, and from viewROutes we call the authController.isLoggedIn
              //route handler which finds that req.cookies.jwt = ''
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type, " was updated succesfully"));
            }
...
var stripe = Stripe('pk_test_51I9fSqFVpNwDVwOzNeg6Ugfg7lw2GDA5bI9yyGvFBJ1Q5cN8ZIdZEGg58douRVUzNiRc3UWqcu1Ri9I7XLeYdh3q00PrXe3JBc');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //use stripe object to create checkout form and charge credit card
